...
import { FilterMatchMode, FilterOperator } from 'primereact/api';
 ...
 const DataTableCrudDemo = () => {
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <React.Fragment>
                <Button icon="pi pi-folder" className="p-button-rounded p-button-success mr-2" onClick={() => editProduct(rowData)} />
        ...
        <div className="datatable-crud-demo">
            ...
            <Dialog visible={productDialog} style={{ width: '450px' }} header="Record Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                <div className="field">
                    ...
                    <InputText id="name" value={product.recordName} onChange={(e) => onInputChange(e, 'name')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.recordName })} />
